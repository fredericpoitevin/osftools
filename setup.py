...
metadata = {
    ...
    'license': 'MIT',
    'platforms': ['Linux', 'OSX'],
    'description': "OSF API convenience tools",
    'long_description': """some convenience tools to interact with OSF API."""}
...
metadata['packages']     = ['osftools']
metadata['package_dir']  = {'osftools' :         'src'}
